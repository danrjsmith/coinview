...
export declare type FindSelectionUnion<i, p, path extends any[] = []> = p extends NamedSelectPattern<infer k> ? {
    [kk in k]: [i, path];
...
} : never : never : IsPlainObject<p> extends true ? i extends object ? {
